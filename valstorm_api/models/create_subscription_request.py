...
class CreateSubscriptionRequest(BaseModel):
    ...
    client_state: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resource", "change_type", "webhook_url", "client_state"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if client_state (nullable) is None
        # and model_fields_set contains the field
        if self.client_state is None and "client_state" in self.model_fields_set:
            _dict['client_state'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client_state": obj.get("client_state")
        })
        return _obj
