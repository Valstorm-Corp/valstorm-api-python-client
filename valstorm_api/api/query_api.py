...
class QueryApi:
    ...
    @validate_call
    def mongo_query_route_v2_v1_query_mongo_post(
        self,
        mongo_query_request: MongoQueryRequest,
        ...
        :param mongo_query_request: (required)
        :type mongo_query_request: MongoQueryRequest
        ...
        _param = self._mongo_query_route_v2_v1_query_mongo_post_serialize(
    ...
    @validate_call
    def mongo_query_route_v2_v1_query_mongo_post_with_http_info(
        self,
        mongo_query_request: MongoQueryRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mongo_query_route_v2_v1_query_mongo_post_without_preload_content(
        self,
        mongo_query_request: MongoQueryRequest,
        _request_timeout: Union[
            None,
    ...
    def _mongo_query_route_v2_v1_query_mongo_post_serialize(
        self,
        mongo_query_request,
        _request_auth,
        _content_type,
        ...
        if mongo_query_request is not None:
            _body_params = mongo_query_request
    ...
    @validate_call
    def sql_query_post_route_v1_query_post(
        self,
        ...
        _param = self._sql_query_post_route_v1_query_post_serialize(
    ...
    @validate_call
    def sql_query_post_route_v1_query_post_with_http_info(
        self,
        request_body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def sql_query_post_route_v1_query_post_without_preload_content(
        self,
        request_body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    def _sql_query_post_route_v1_query_post_serialize(
        self,
        request_body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def sql_query_route_v1_query_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._sql_query_route_v1_query_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def sql_query_route_v1_query_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def sql_query_route_v1_query_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _sql_query_route_v1_query_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
